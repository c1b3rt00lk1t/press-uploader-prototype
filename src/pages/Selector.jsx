...
const Selector = ({clickSelector, handleSelectFolder, basicFolderChecks, prepareTaggedFiles, preTaggerChecks}) => {
  return (
    <div>
      Press Selector
      <div id="selector">
        ...
        <button onClick={prepareTaggedFiles} disabled={!preTaggerChecks}>Prepare tagger</button>
      </div>
